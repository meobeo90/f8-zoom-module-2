...
// ===================== RENDER SECTIONS =====================
// Hàm dùng chung để ẩn/hiện các phần tử (đặt ở đây vì nó được dùng cho cả 2 hàm loadDetail)
...
export async function loadPlaylistDetail(id) {
  try {
    ...
    // Ẩn playlists và artists, Hiện playlist hero
    toggleSections({
...
// ========== update detail functions ==========
function updatePlaylistDetail(playlist) {
